...
var star1, star2, star_img, noStars,oneStar,twoStars;
var balloon;
var stars_count = 0;
...
function preload()
{
  ...
  noStars = loadImage('empty.png');
  oneStar = loadImage('one_star.png');
  twoStars = loadImage('stars.png');
...
function setup() 
{
  ...
  star_display.addAnimation('empty',noStars);
...
function draw() 
{
  ...
  //  if(stars_count === 0) {
  //   image(noStars,50,50,80,40);
  //  } else if (stars_count === 1) {
  //   image(oneStar,50,50,80,40);
  //  } else if (stars_count === 2) {
  //   image(twoStars,50,50,80,40);
  //  }
